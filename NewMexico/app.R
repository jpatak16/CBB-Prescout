...
GMC_OS = read.csv("data/NewMexico_GMC_OS.csv")
GMC_NET = read.csv("data/GMC_NET.csv")
GMC_medians = read.csv("data/GMC_medians.csv")
graphic_info_OS = read.csv("data/NewMexico_graphic_info_OS.csv")
...
server = function(input, output, session) {
  ...
  output$header7 = output$header6 = output$header5 = output$header4 = output$header3 = output$header2 = output$header = 
    renderUI(HTML(paste('<h1 style="color:#ba0c2f;font-size:50px">', our_team, " vs ", input$opponent, '</h1>', sep = "")))
