...
GMC_OS = read.csv("data/Clemson_GMC_OS.csv")
GMC_NET = read.csv("data/GMC_NET.csv")
GMC_medians = read.csv("data/GMC_medians.csv")
graphic_info_OS = read.csv("data/Clemson_graphic_info_OS.csv")
...
ui = navbarPage("Pre-Scout Portal", fluid = TRUE, 
                ...
                tabPanel("Matchup Selection", 
                         fluidRow(column(3, selectInput("opponent", "Opponent", opponentList)),
                                  ...
                                  column(3, img(src="logo_clemson.png", height = 180, width = 165))
...
server = function(input, output, session) {
  ...
  #Clemson vs TEAM text output for header on top of all pages
  output$header7 = output$header6 = output$header5 = output$header4 = output$header3 = output$header2 = output$header = 
    renderUI(HTML(paste('<h1 style="color:purple;font-size:50px">', our_team, " vs ", input$opponent, '</h1>', sep = "")))
